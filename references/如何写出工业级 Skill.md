---
title: 如何写出工业级 Skill
source: https://x.com/Ryrenz/status/2051111166416396713
---
[[index]]
...
![Image](https://pbs.twimg.com/media/HKWMaUCXIAA3UjI?format=jpg&name=large)
...
Anthropic 自己出了一个内置 Skill 叫 skill-creator，[Claude.ai](https://claude.ai/) 插件目录可装，Claude Code 也能直接下载。
...
**第二步：上传到** [Claude.ai](https://claude.ai/)

- 把整个 skill 文件夹打包成 zip
- 打开 [Claude.ai](https://claude.ai/) → Settings → Capabilities → Skills → Upload skill
- 选 zip → 开启 → 测试
...
![Image](https://pbs.twimg.com/media/HJMkT5CWYAAbtGQ?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJMmWSnWwAASR2e?format=jpg&name=large)
